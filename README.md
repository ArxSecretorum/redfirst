...
<!-- redfirst-count: cases=145 checks=304 -->
```sh
sh tests/run              # 145 cases across dash and bash — 304 checks
...
word "clean" becomes unavailable. Out of 304 checks, six are skipped on Windows
